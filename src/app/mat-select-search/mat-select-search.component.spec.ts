...
@Component({
  ...
  template: `
    ...
    <p>
      <mat-form-field>
        <mat-select
          [formControl]="bankCtrlMatOption"
          placeholder="Bank"
          #selectSingleMatOption
        >
          <mat-option>
            <ngx-mat-select-search
          ...
          <mat-option
            *ngFor="let bank of filteredBanksMatOption | async"
            [value]="bank"
          >
            {{ bank.name }}
          </mat-option>
  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  @ViewChild("selectSearchSingleMatOption")
  matSelectSearchMatOption: MatSelectSearchComponent;
  @ViewChild("selectSearchMulti")
  matSelectSearchMulti: MatSelectSearchComponent;
  ...
  public filteredBanksMatOption: ReplaySubject<Bank[]> = new ReplaySubject<
    Bank[]
  >(1);
  ...
  private setInitialValue() {
    this.filteredBanks
      ...
      .subscribe(() => {
        ...
        this.matSelect.compareWith = (a: Bank, b: Bank) =>
          a && b && a.id === b.id;
        this.matSelectMatOption.compareWith = (a: Bank, b: Bank) =>
          a && b && a.id === b.id;
        this.matSelectMulti.compareWith = (a: Bank, b: Bank) =>
          a && b && a.id === b.id;
      });
  }
      ...
      component.filteredBanks.pipe(take(1), delay(1)).subscribe(() => {
        ...
        component.matSelect.openedChange
          ...
          .subscribe((opened) => {
            ...
            const searchInner = document.querySelector(
        ...
        component.matSelect.openedChange.pipe(take(1)).subscribe((opened) => {
          ...
          component.filteredBanks.pipe(take(1)).subscribe(() => {
            ...
            setTimeout(() => {
              ...
              expect(component.matSelect.options.first.active).toBe(
                true,
                "first active"
              );
    ...
    it("should not announce active option if there are no options", (done) => {
      ...
      component.filteredBanks.pipe(take(1), delay(1)).subscribe(() => {
        ...
        component.matSelect.openedChange.pipe(take(1)).subscribe((opened) => {
          ...
          component.matSelectSearch._formControl.setValue(
            "something definitely not in the list"
          );
          fixture.detectChanges();
          ...
          component.filteredBanks.pipe(take(1)).subscribe(() => {
            ...
            setTimeout(() => {
              ...
              component.matSelectSearch._handleKeyup(<KeyboardEvent>{
                keyCode: DOWN_ARROW,
              });
              ...
              .subscribe((opened) => {
                ...
                component.filteredBanks.pipe(take(1)).subscribe(() => {
                  ...
                  setTimeout(() => {
                    ...
                    expect(
                      component.matSelectMatOption.options.toArray()[1].value.id
                    ).toBe("C");
                    expect(
                      component.matSelectMatOption.options.toArray()[1].active
                    ).toBe(true, "first active");
                    ...
                    component.filteredBanks.pipe(take(1)).subscribe(() => {
                      fixture.detectChanges();
                      expect(component.matSelectMatOption.options.length).toBe(
                        5
                      );
              ...
              .subscribe((opened) => {
                ...
                component.filteredBanks.pipe(take(1)).subscribe(() => {
                  ...
                  setTimeout(() => {
                    ...
                    expect(
                      component.matSelectMulti.options.first.value.id
                    ).toBe("C");
                    expect(component.matSelectMulti.options.first.active).toBe(
                      true,
                      "first active"
                    );
                    ...
                    setTimeout(() => {
                      ...
                      component.filteredBanks.pipe(take(1)).subscribe(() => {
                        ...
                        setTimeout(() => {
                          expect(component.matSelectMulti.options.length).toBe(
                            1
                          );
                          expect(
                            component.matSelectMulti.options.first.value.id
                          ...
                          expect(
                            component.matSelectMulti.options.first.active
                          ).toBe(true, "first active");
